...
//
        ...
        protected override void AddButtons()
        {
            ...
            AddButton(new GUIContent("New", "Create New Graph"), () =>
            {
            ...
            AddToggle(new GUIContent("ExposedParams", "Toggle ExposedParams"),
            ...
            AddToggle(new GUIContent("Map", "toggle mini map"), m_MiniMap.visible,
            ...
            AddToggle(new GUIContent("Conditional", "Toggle Conditional"),
            ...
            AddButton(new GUIContent("ShowFile",  "to see file"),
                () =>
                {
            ...
            var path = AssetDatabase.GetAssetPath(m_BaseGraph);
            ...
            AddCustom(() =>
            {
                ...
                GUILayout.Label(assetName, EditorGUIStyleHelper.GetGUIStyleByName(nameof(EditorStyles.toolbarButton)));
                GUI.color = Color.white;
            });
